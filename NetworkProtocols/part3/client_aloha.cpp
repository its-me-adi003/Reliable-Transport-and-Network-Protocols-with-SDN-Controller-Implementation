...
void *helper(void *arg){
   ...
   //     cout<<"this this  client: "<<client_socket<<" "<<random_value<<" "<<request<<" "<<prob<<endl;
        if(random_value<=prob){
        //    cout<<"hi"<<endl;
            int send_status=send(client_socket, request.c_str(), request.length(), 0);
            cout<<"this clientdwedfdscsd: "<<client_socket<<send_status<<endl;
         //   bool end_of_iteration = 0;
            ...
            cout<<"offset after loop :"<<*offset<<" "<<client_socket<<endl;
        }
