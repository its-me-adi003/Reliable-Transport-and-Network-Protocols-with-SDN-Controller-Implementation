...
struct client_data {
    ...
    client_data(server_data* state) : server_state(state) {}  // Constructor to initialize server_state
};
...
int main() {
    ...
    while (true) {
        ...
        client_data* data = new client_data(&server_state);  // Allocate memory for the client data
